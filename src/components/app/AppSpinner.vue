...
<template>
    <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"
        ...
        <circle class="loader-svg" cx="50" cy="50" fill="none" stroke="#d6e2fb" stroke-width="7" r="35"
            stroke-dasharray="164.93361431346415 56.97787143782138" transform="rotate(159.821 50 50)">
